...
def myexcepthook(type, value, tb):
    ...
    if nav_stack_process != None:
        nav_stack_process.terminate()
        nav_stack_process.wait()

    if planner_process != None:
        planner_process.terminate()
        planner_process.wait()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--goal_idx', type=int, default=3)
    ...
    while not run_failed:
        ...
        world_name = "clutteredEnvironment.world"
        ...
        INIT_POSITION = POSITIONS[args.start_idx]
        GOAL_POSITION = POSITIONS[args.goal_idx]
        ...
        if args.bag:
            ...
            bag_fname="clutteredEnv_%d_%d_solver_%d" %(args.start_idx, args.goal_idx, args.solver)
        ...
        planner_launch_file = join(planner_path, 'launch/planner.launch') if args.solver == 0 else join(planner_path, 'launch/planner_gurobi.launch')
        ...
        print("run failed is", run_failed)
