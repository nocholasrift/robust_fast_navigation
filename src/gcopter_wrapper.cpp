...
bool GcopterWrapper::setup(const Eigen::MatrixXd &start,
  ...
  return _solver.setup(20.0, start_pva, end_pva, polys, 1e6, 1e-2, 16,
...
Eigen::MatrixXd GcopterWrapper::get_ctrl_pts() { return Eigen::MatrixXd(); }

void GcopterWrapper::set_params(const planner_params_t &params) {
  _params = params;
}
